                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => PdfViewerScreen(
                                          url: snapshot.data!.docs[index]['pdf']
                                              .toString(),
                                        ),
                                      ),
                                    );
...
class KidsDetailData {
  ...
  factory KidsDetailData.fromJson(Map<String, dynamic> json) {
    return KidsDetailData(
...
Future<KidsDetailData> fetchKidsData() async {
  final response = await http.get(Uri.parse('https://api.example.com'));

  if (response.statusCode == 200) {
    final jsonData = jsonDecode(response.body);
    return KidsDetailData.fromJson(jsonData);
  } else {
