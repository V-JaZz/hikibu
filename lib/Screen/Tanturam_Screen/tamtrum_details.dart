...
class TamtrumDetailData {
  ...
  factory TamtrumDetailData.fromJson(Map<String, dynamic> json) {
    return TamtrumDetailData(
...
Future<TamtrumDetailData> fetchTamtrumDetailData() async {
  final response = await http.get(Uri.parse('https://api.example.com'));

  if (response.statusCode == 200) {
    final jsonData = jsonDecode(response.body);
    return TamtrumDetailData.fromJson(jsonData);
  } else {
