...
class TanturamData {
  ...
  factory TanturamData.fromJson(Map<String, dynamic> json) {
    return TanturamData(
...
Future<TanturamData> fetchTanturamData() async {
  final response = await http.get(Uri.parse('https://api.example.com'));

  if (response.statusCode == 200) {
    final jsonData = jsonDecode(response.body);
    return TanturamData.fromJson(jsonData);
  } else {
    throw Exception('Failed to fetch user data');
  }
}

class TanturamHeaderData {
  final String title;
  ...
  factory TanturamHeaderData.fromJson(Map<String, dynamic> json) {
    return TanturamHeaderData(
      title: json['title'],
...
Future<TanturamHeaderData> fetchTanturamHeaderData() async {
  final response = await http.get(Uri.parse('https://api.example.com'));

  if (response.statusCode == 200) {
    final jsonData = jsonDecode(response.body);
    return TanturamHeaderData.fromJson(jsonData);
  } else {
    throw Exception('Failed to fetch user data');
  }
}
